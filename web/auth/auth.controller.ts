...
export class AuthController {
  ...
  public register = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (check_user && !check_user.email_verified) {
        await AuthService.sendEmailVerifyLink(res.locals.project, check_user, body.ip as string);
  ...
  public resendVerificationEmail = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      await AuthService.sendEmailVerifyLink(res.locals.project, find_user, body.ip as string);
  ...
  public forgotPassword = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const email = await AuthService.sendForgotPasswordLink(res.locals.project, find_user, body.ip as string);
